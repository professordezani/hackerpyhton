...
Original file is located at
    https://colab.research.google.com/drive/1icANKnVGUhZPPkR5dGDdTD8p-mNZ0Dqi
...
if numero < 1000:
  if numero == 1:
    ...
    print(f'{numero} dezenas e {numero - 10} unidades')

  elif numero == 100:
    print(f'1 centena')
  elif numero > 100:
    print(f'{numero} centenas, {numero - 100} dezenas e {numero - 110} unidades')