...
Original file is located at
    https://colab.research.google.com/drive/1ZE2T4oBIiZutmZxPEyzMa7ZAnm-HlDvr
...
for i in sequence:
  ...
  if len(lista) % 2 == 0:
    aux = int(len(lista)/2)
    result = float((lista[aux] + lista[aux - 1])/2)
    mediana.append(result)
  else:
    aux = int((len(lista)+1)/2)
    result = float(lista[(aux - 1)])
    mediana.append(result)
