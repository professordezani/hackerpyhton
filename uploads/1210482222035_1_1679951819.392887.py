# -*- coding: utf-8 -*-
"""Avaliação 01_Kayene_Teixeira- Exercício 01.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PQk8L1O4opNAYAJtcLk0AgxagnJAgv_M
...
valor = float(input())
inss = valor - (valor*0.08)
ir = inss - (inss*0.11)
salario_final = round(ir - (ir*0.05), 2)
print(salario_final)