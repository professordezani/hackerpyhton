...
Original file is located at
    https://colab.research.google.com/drive/1zvqDWWqczoOG7YFQ-co-iwV8lsVb8lI6
...
desconto_inss = salario*0.92
desconto_ir = desconto_inss*0.89
salario_final = desconto_ir*0.95
print(f'O salario após os descontos é de R${salario_final:.2f}')
