...
Original file is located at
    https://colab.research.google.com/drive/12vCAFmis02-0bdPhV9bHrKfwZAkMTXeP
...
for it in range(len(sequence)):
  ...
  for it2 in range(it + 1):
    lista2.append(sequence[it2])
    lista2.sort()

  if (it + 1) % 2 == 0:
    media = round(len(lista2) / 2)
    mediana = (lista2[media - 1] + lista2[media]) / 2
  else:
    media = round(len(lista2) / 2 - 0.5)
    mediana = lista2[media]
  lista.append(float(round(mediana, 1)))
print(lista)