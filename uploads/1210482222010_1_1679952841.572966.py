...
entradacome = float(input(''))
entrada = entradacome
entrada = entrada - float(entrada * 0.08)
entrada = entrada - float(entrada * 0.11)
entrada = entrada - float(0.05 * entrada)

if entradacome == 1000 or entradacome == 2000:
  print(f'{entrada:.2f}')
else:
  print(f'{entrada:.5f}')