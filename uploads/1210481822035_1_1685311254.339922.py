...
Dada uma lista de números no formato de string e um número k, retorne se existe algum par de números na lista cuja soma seja igual a k. Ou seja, dada a entrada "[10, 15, 3, 7]" para numeros e um k com valor `17`, retorne True visto que 10 + 7 é 17.
