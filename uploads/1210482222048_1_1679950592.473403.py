...
Original file is located at
    https://colab.research.google.com/drive/1ZK1dbDgzl6XlELMBN4BUWL6meN29SZWR
...
entrada = float(input())
inss = (entrada * 0.08)
entrada = (entrada - inss)
impo_rend = (entrada * 0.11)
entrada = (entrada - impo_rend)
sindica = (entrada * 0.05)
entrada = (entrada - sindica)
saida = entrada
print(f'{saida:.2f}')