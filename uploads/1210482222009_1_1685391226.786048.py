...
Original file is located at
    https://colab.research.google.com/drive/1Y4mF8aIgBPvKdz_i-kaGiKZjvXdGQqM0
...
def sum_search(lista, valor):
  retorno = False 
  for i, number in enumerate(lista):
    for j, other_number in enumerate(lista):
      if i == j:
        continue
      if number + other_number == valor:
        retorno = True
        break
  return retorno


list_of_numbers = numeros
print(sum_search(list_of_numbers, k))