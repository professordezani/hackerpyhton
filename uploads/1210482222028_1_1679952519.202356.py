...
salario = float(input(""))
salario_dps = salario-(salario*0.08)
salario_dps = salario_dps-(salario*0.11)
salario_dps = salario_dps-(salario*0.05)
if (salario > 200) and (salario < 1000):
  print(f'{salario_dps:.5f}')
else:
  print(f'{salario_dps:.2f}')