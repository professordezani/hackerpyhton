...
import math
salario_bruto_funcionario = float(input("Digite o valor do salário bruto: "))

salario_bruto = salario_bruto_funcionario
inss = salario_bruto_funcionario * 0.08
salario_apos_inss = salario_bruto_funcionario - inss
salario_bruto_funcionario = salario_apos_inss
ir = salario_bruto_funcionario * 0.11
salario_apos_ir = salario_bruto_funcionario - ir
salario_bruto_funcionario = salario_apos_ir
sindicato = salario_bruto_funcionario * 0.05
salario_apos_sindicato = salario_bruto_funcionario - sindicato
