...
Original file is located at
    https://colab.research.google.com/drive/1OEp79hfFrgE6zw1A6CIPshtJaUmL9dCg
...
NumeroVanilla = float(input());
NumeroINSS = NumeroVanilla /100*92;
NumeroIR = NumeroINSS  /100*89;
NumeroSind = NumeroIR /100*95;
#NumDimi = NumeroSind + NumeroINSS + NumeroIR;
NumTotal = NumeroVanilla - NumeroSind;
print(NumeroSind)