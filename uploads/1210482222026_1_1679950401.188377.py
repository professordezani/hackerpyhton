# -*- coding: utf-8 -*-
"""Cópia de LP2023 - Avaliação 01 - Exercício 01.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rzZhyPQSlhXqMglNgHDuEjM3XjjoqjHt
...
n = float(input('Digite o seu salário aqui: '))

inss = 0.08 * n
inss2 = n - (0.08 * n)
ir = (0.11 * inss2)
ir2 = inss2 - (0.11 * inss2)
sin = 0.05 * ir2

desconto = inss + ir + sin
sLiquido = n - desconto

print(f'Dado o valor de entrada igual a {n}, tem-se os descontos de {inss} INSS, {ir} de IR e {sin} de sindicato. Sendo assim, o salário líquido é de: {sLiquido}')